...
The secondary menu is grouped into Data, App, and Danger sections. Keep reset at the bottom in the Danger section, close the menu before presenting its confirmation, offer backup first, and require a second explicit confirmation before clearing records and trigger metadata.
